...
const judge = (answer, submit) => { // 결과를 "Draw", "Lose", "Win" 형태로 도출하여 String의 형태로 return하세요!
     ...
     */
     if((answer==-1 && submit==0)||(answer==0 && submit==1)||(answer==1 && submit==-1))
     {
       return "Win";
     }

     else if((answer==0 && submit==0)||(answer==1 && submit==1)||(answer==-1 && submit==-1))
     {
       return "Draw";
     }

     else((answer==0 && submit==-1)||(answer==1 && submit==0)||(answer==-1 && submit==1))
     {
       return "Lose";
     }
};
